    ...
    <div className={styles.aboutComponent}>
      <div className={styles.row}>
        ...
        <div className={styles.rightColumn}>
          ...
          <p className={styles.companyDescription}>We are here to help you plan your next event, whether that be a small backyard party, or a much larger city or corporate event. We are an upscale rental company offering
